...
parser.add_argument("--num-robots", type=int, default=4, help="Number of robots (default: 1)")
parser.add_argument(
    "--env-path",
    default=f"{os.getcwd()}/../usd/apartment/apartment.usd",
    required=False,
    help="Path to the environment usd file",
)
